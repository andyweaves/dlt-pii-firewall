...
<p align="center">
  src="[https://www.python.org/python-.png](https://user-images.githubusercontent.com/43955924/172699498-6a02b84e-a020-4cf5-a4d2-43d94d480f1f.png)">
</p>
...
* Show nested and semi-structured data some love - based on my testing, the pipeline won’t fail if you throw semi-structured data at it, but it won’t iterate recursively through the nested objects to find and protect PII. At the moment we extract the column names of input data and use those to dynamically build our expectations, but there’s no reason why we couldn’t extract the schema and iterate over that as well.
